    ...
    <div class="relative w-full px-4 h-full md:h-auto {{ 'modal-'.$size }}">
        <div class="bg-white rounded-lg shadow relative">
            <div class="flex items-start justify-between p-5 border-b rounded-t">
                ...
                <button {{ $cleanAction ? "@click.stop=\$wire.$cleanAction()" : ''}} type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-toggle="add-user-modal">
