        ...
        <form wire:submit.prevent="save">
            <div class="grid grid-cols-6 gap-6">
                <div class="col-span-6 sm:col-span-3">
                    <x-inputs.text wire:model="data.ruc" type="text" name="ruc" id="ruc" label="RUC" />
                    @error('data.ruc')
                    <p class="text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                <div class="col-span-6 sm:col-span-3">
                    <x-inputs.text wire:model="data.agent_name" type="text" id="agent_name" name="agent_name" label="Nombre del agente"/>
                ...
                <div class="col-span-6 sm:col-span-3">
                    <x-inputs.text wire:model="data.branch" type="text" name="branch" id="branch" label="Branch"/>
                    @error('data.branch')
                    <p class="text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                <div class="col-span-6 sm:col-span-3">
                    <x-inputs.text wire:model="data.address" type="text" name="address" id="address" label="Dirección"/>
                    @error('data.address')
                    <p class="text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                <div class="col-span-6 sm:col-span-3">
                    <x-inputs.text wire:model="data.phone_number" type="text" name="phone_number" id="phone_number" label="Número Telefónico" />
